...
This dynamic report aims to investigate how heart rate for the subject (me) changes throughout the day including which activities were being done and what time of day it was.
...
The activity type which had the highest average heart rate was chores (`r activity_means[3]` bpm), followed by eating/drinking (`r activity_means[1]` bpm), then studying (`r activity_means[2]` bpm), and lastly recreation which had the lowest average heart rate (`r activity_means[4]` bpm).
